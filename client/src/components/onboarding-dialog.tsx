...
const steps = [
  ...
  },
  {
    ...
    description: "Open an application and add the funder's questions — paste them in or upload the form to extract them automatically.",
  ...
  },
  {
    ...
    description: "Review each drafted response, check citations, and export polished answers when your team is ready.",
