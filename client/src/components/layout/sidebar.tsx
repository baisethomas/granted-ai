    ...
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors ${
                      isActive
                        ...
                        : "text-gray-700 hover:text-primary hover:bg-[#EAF2FE]"
                    }`}
                  >
            ...
            {resourceNavItems.map((item) => {
              ...
              return (
                <li key={item.id}>
                  <a
                    href={item.href}
                    className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:text-primary hover:bg-[#EAF2FE] rounded-md transition-colors"
                  >
                    <Icon className="w-5 h-5 mr-2" />
                    {item.label}
                  </a>
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center">
          <div className="w-8 h-8 bg-[#EAF2FE] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
